...
db.on('connected', function () {
    ...
    appLogger.info('Mongoose default connection open to ' + config.db.serverIP)
})
...
db.on('error', function (err) {
    ...
    appLogger.error("Mongoose default connection error:", err)
})

// When the connection is disconnected
db.on('disconnected', function () {
    //console.log('Mongoose default connection disconnected')
    appLogger.info('Mongoose default connection disconnected')
})
...
process.on('SIGINT', function () {
    db.close(function () {
        ...
        appLogger.error('Mongoose default connection disconnected through app termination');
        process.exit(0)
    })
})
